const translations = {
   ...
   AboutMe: {
      about: 'sobre',
      me: 'mí',
      apresentation: '¡Hola! Soy Sávio Almeida, un desarrollador apasionado por crear interfaces web y aplicaciones intuitivas y visualmente atractivas. Con 3 años de experiencia, tengo un sólido conocimiento en HTML, CSS y JavaScript, además de bibliotecas y frameworks populares como React, Vue.js y Next.Js.',
