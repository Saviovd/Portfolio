...
import { SiJquery,  SiTypescript, SiWebpack, SiPostman, SiMysql, SiJest, SiTailwindcss,  } from "react-icons/si"
    ...
    return (<div className='skills'>
        ...
        <div className='rolling' >
            <ul className="skill_list primary">
                ...
                <li style={{color: "#48bbf5"}} className="skills_item"><SiTailwindcss className='skills_icons'/></li>
                ...
                <li style={{color: "#933d56"}} className="skills_item"><SiJest className='skills_icons'/></li>
                <li style={{color: "#f1663c"}} className="skills_item"><SiPostman className='skills_icons'/></li>
                <li style={{color: "#f1663c"}} className="skills_item"><SiMysql className='skills_icons'/></li>
            </ul>
